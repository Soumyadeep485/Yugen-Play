...
class PluginRegistry {
  ...
  List<PluginMeta> getActivePlugins() {
    return getInstalledPlugins().where((p) => p.enabled).toList();
  }
  ...
  Map<String, dynamic> get plugins => _plugins;

  void registerPlugin(String id, dynamic plugin) {
    _plugins[id] = plugin;
  }
}
